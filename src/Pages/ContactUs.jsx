...
const ContactUs = () => {
  return (
    <AnimatedPage>
        <section className="relative py-28 mt-24 bg-gray-900">
            <div className="relative z-10 max-w-screen-xl mx-auto text-gray-600 sm:px-4 md:px-8">
                ...
                <div className="mt-12 mx-auto px-4 p-8 isolate bg-white/65 shadow-lg ring-1 ring-black/5 sm:max-w-lg sm:px-8 sm:rounded-xl">
                    <form
